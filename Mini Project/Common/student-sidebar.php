		...
		<nav id="sidebarMenu" class="">
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					<li class="nav-item">
						<a class="nav-link" href="../student/student-info.php">
						<span data-feather="file"></span>
						<i class="fa fa-user mr-2" aria-hidden="true"></i> Personal Profile
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-jobs.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-briefcase mr-2" aria-hidden="true"></i> Job Openings
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../student/student-applications.php">
						<span data-feather="users"></span>
						<i class="fa fa-list-alt mr-2" aria-hidden="true"></i> Applications
						</a>
					</li>
					<li class="nav-item">
